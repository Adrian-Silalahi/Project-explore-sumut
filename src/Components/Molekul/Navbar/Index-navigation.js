  ...
  render() {
    ...
    <Fragment>
      <nav className="navbar navbar-expand-lg navbar-light ">
        <Nav.Link className="navbar-brand  text-light fs-2 fw-bold " href="#">Explore Sumut</Nav.Link>
        ...
        <div className="collapse navbar-collapse daftar-halaman" id="navbarNav">
          <ul className="navbar-nav">
            ...
            <li className="nav-item ">
              <Nav.Link className="nav-Link text-light" href="#Destination">Destination</Nav.Link>
            </li>
            <li className="nav-item ">
              <Nav.Link className="nav-Link text-light" href="#Gallery">Gallery </Nav.Link>
            </li>
          </ul>
        </div>
      </nav>
